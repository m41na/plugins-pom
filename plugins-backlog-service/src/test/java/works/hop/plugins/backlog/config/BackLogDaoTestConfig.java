...
import com.jarredweb.plugins.backlog.dao.BackLogDaoImpl;

@Configuration
@EnableTransactionManagement
public class BackLogDaoTestConfig {
    ...
    @Bean
    @Autowired
    public BackLogDao backLogDao(DataSource ds) {
        return new BackLogDaoImpl(ds);
    }
}
