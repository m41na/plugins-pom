...
@ComponentScans(value = { @ComponentScan(basePackages = "works.graphql") })
...
public class HibernateTestConfig {
	...
	public LocalSessionFactoryBean sessionFactory() {
		...
		sessionFactory.setPackagesToScan("works.graphql.entity");
	...
	private Properties hibernateProperties() {
		...
		props.setProperty("hibernate.hbm2ddl.import_files", env.getProperty("hibernate.dialect"));
		return props;
	}
}
